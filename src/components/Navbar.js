...
const Navbar = () => {
  ...
  const handleLogout = () => {
    const updateUser = async () => {
      const url = 'https://quora-for-college-backend.onrender.com/api/users/updateUser'
  ...
  const leaveSchool = async () => {
    ...
    const url = `https://quora-for-college-backend.onrender.com/api/schools/leaveSchool/${school}`
