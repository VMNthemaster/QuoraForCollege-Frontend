...
const AdminLogin = () => {
  ...
  const sendRequestToBackend = async () => {
    const url = 'https://quora-for-college-backend.onrender.com/api/users/adminLogin'
    ...
    <div className="flex flex-col w-[90vw] md:w-[50vw] px-[1.25vw] md:px-[1.5vw] py-[1vw] border-[0.5px] md:border-[2px] border-red-600 rounded-md">
      ...
      <form className="flex flex-col gap-y-[2vh] py-[1.5vh]">
        ...
        <div className='flex -mt-[1vh]'>
          <Link to='/signin' className='text-[0.6rem] md:text-[0.95rem] font-medium  text-red-500 underline focus:outline-none clickEffect'>SignIn Instead</Link>
        </div>
